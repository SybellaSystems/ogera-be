...
exports.UserMessages = {
    ...
    ERROR_CREATE_USER: 'An error occurred while creating the user. Please try again.',
    UPDATE_USER: 'The user details have been updated successfully.',
    USER_FOUND: 'The user details have been retrieved successfully.',
    ...
    INVALID_USER_ID: 'The provided user ID is invalid. Please check and try again.',
    EMAIL_ALREADY_REGISTERED: 'The provided email address is already registered. Please use a different email.',
    ...
    OTP_RESET_TOKEN_REQOIRED: 'OTP and reset token are required.',
    INVALID_RESET_TOKEN: 'Invalid or expired reset token.',
    NEW_PASS_RESET_TOKEN_REQUIRED: 'New password and reset token are required.',
    ...
    FETCH_STUDENTS: 'Students fetched successfully',
    FETCH_EMPLOYERS: 'Employers fetched successfully',
    NO_USERS_FOUND: 'No users found',
    NO_STUDENTS_FOUND: 'No students found',
    NO_EMPLOYERS_FOUND: 'No employers found',
};
