...
export const login = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    response.response(res, true, StatusCodes.OK, result, Messages.User.LOGGED_IN);
  } catch (error: any) {
    response.errorResponse(res, error.status || StatusCodes.INTERNAL_SERVER_ERROR, false, error.message);
  }
};
...
export const forgotPassword = async (req: Request, res: Response) => {
  try {
    ...
    response.response(res, true, StatusCodes.OK, result, Messages.User.OTP_SUCCESS);
  } catch (error: any) {
    response.errorResponse(res, error.status || StatusCodes.INTERNAL_SERVER_ERROR, false, error.message);
  }
};
...
export const verifyResetOTP = async (req: Request, res: Response) => {
  try {
    ...
    response.response(res, true, StatusCodes.OK, {}, Messages.User.OTP_VERIFICATION_SUCCESS);
  } catch (error: any) {
    response.errorResponse(res, error.status || StatusCodes.INTERNAL_SERVER_ERROR, false, error.message);
  }
};
...
export const resetPassword = async (req: Request, res: Response) => {
  try {
    ...
    response.response(res, true, StatusCodes.OK, {}, Messages.User.PASSWORD_RESET_SUCCESS);
  } catch (error: any) {
    response.errorResponse(res, error.status || StatusCodes.INTERNAL_SERVER_ERROR, false, error.message);
  }
};
